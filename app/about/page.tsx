      ...
      <div className="h-[95vh] max-h-screen lg:h-[40vh] 2xl:h-[40vh] flex flex-col grow justify-around">
        <div className=" lg:grid lg:grid-cols-2">
          ...
          >
            <p>
              ...
              creation and visual arts, 2regards Atelier was founded in Porto
              by the photographer Mathilde Cudeville and videographer Paulo
              Bastos. With a focus on advertising, they transform
              products into captivating visual stories that encapsulate the
              essence of a brand through photography, video and graphic design.
            </p>
          </motion.div>

          {/* Title desktop */}
          <div className="hidden lg:flex justify-center items-center m-4 text-center text-black">
            <div>
              <h1 className=" hidden lg:block text-6xl lg:text-[80px] font-normal font-italiana uppercase leading-[30px] lg:leading-[38px] tracking-tighter">
                2 regards{" "}
              </h1>
              <h1 className="hidden lg:block text-6xl lg:text-[80px] font-normal font-italiana leading-[30px] lg:leading-[38px] tracking-tighter">
                Atelier
              </h1>
            </div>
          </div>
        ...
        <div>
          <div className="lg:hidden m-4 text-center text-black">
            <h1 className="lg:hidden text-4xl xs:text-6xl  font-normal font-italiana uppercase leading-[20px] xs:leading-[30px] lg:leading-[38px] tracking-tighter">
              2 regards{" "}
            </h1>
            <h1 className="lg:hidden text-5xl xs:text-6xl  font-normal font-italiana leading-[20px] xs:leading-[30px] lg:leading-[38px] tracking-tighter">
              Atelier
            </h1>
          </div>
        </div>
        <div className="flex flex-col justify-center items-center">
          ...
          >
            <p>
              ...
              art gallery welcoming local and international artists
              throughout the year. The space includes a commercial photography
              studio, an analog laboratory and post-production offices, where
              training sessions for analogue capture and development are
              facilitated.
            </p>
          </motion.div>
