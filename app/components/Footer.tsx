  ...
  return (
    <footer className="fixed left-0 bottom-0 w-screen h-4 md:h-6 bg-stone-200 z-30">
      <div className="relative min-w-screen z-25 border-t-black border-[1px]">
        ...
        <Link href="https://vivieningrams.com" target="_blank" className="hidden md:flex absolute text-[10px] tracking-tight xs:tracking-normal  z-50 leading-loose -bottom-[22px] right-12 text-neutral-500"> Website by Vivien Ingrams</Link>
      </div>
    </footer>
  );
};
